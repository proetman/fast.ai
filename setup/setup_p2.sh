...
if [ $region = "us-west-2" ]; then
  ...
  export ami="ami-39ec055b"               # Asia Pacific - Sydney
else
  echo "Only us-west-2 (Oregon), eu-west-1 (Ireland), us-east-1 (Virginia) and maybe Down Under are currently supported"
  exit 1
fi
